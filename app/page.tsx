  ...
  return (
    <main>
      ...
      <p className="lead">
        ...
        It opens the local demo at http://localhost:1337; the private source is
        not downloaded and the local server must already be running.
      </p>
      ...
      <section>
        ...
        <div><b>02</b><p>Opens the local demo on port <code>1337</code>.</p></div>
